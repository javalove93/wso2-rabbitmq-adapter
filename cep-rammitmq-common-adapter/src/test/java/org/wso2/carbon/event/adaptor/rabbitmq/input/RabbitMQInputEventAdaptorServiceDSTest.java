 ...
 * @version 1.0
 */
public class RabbitMQInputEventAdaptorServiceDSTest {
	...
	public void testActivate() {
		try {
			new RabbitMQInputEventAdaptorServiceDS().activate(null);
		} catch (Exception e) {
		}
	}

}
//end of RabbitMQInputEventAdaptorServiceDSTest.java